...
# ICT skills in Job
newChile1 %>% count(G_Q04) # experience with computer in job yes no 
newChile1%>% count(G_Q04_T) #** 4 N
newChile1 %>% count(COMPUTEREXPERIENCE) #******
newChile1 %>% count(G_Q05a) # 2377 v ESTA 6 
newChile1 %>% count(G_Q05c) # 2377 v ESTA 7 
newChile1%>% count(G_Q05d) # 2377 ESTA 8 
newChile1 %>% count(G_Q05e) # 2377 ESTA 9 
newChile1 %>% count(G_Q05g) # 2377 ESTA 10 
newChile1%>% count(G_Q05h) # 2377 ESTA 11 
newChile1%>% count(G_Q06) # 2377 ESTA 12 
newChile1 %>% count(G_Q07) # 2377 ESTA 13 
newChile1 %>% count(G_Q08) # 2377 ESTA 15 

#ICT skills in daily life
newChile1 %>% count(H_Q04a) # 1074 V experience with compiuter every life
newChile1 %>% count(H_Q04b) # 1198 
newChile1 %>% count(H_Q05a) # 2205 ESTA 16 
newChile1 %>% count(H_Q05c) # 2205 ESTA 17 
newChile1 %>% count(H_Q05d) # 2205 ESTA 18 
newChile1 %>% count(H_Q05e) # 2205 ESTA 19 
newChile1 %>% count(H_Q05f) # 2205 ESTA 20 
newChile1 %>% count(H_Q05g) # 2205 ESTA 21 
newChile1 %>% count(H_Q05h) # 2205 ESTA 22 
