...
subChile$YEARLYINCPR= factor (subChile$YEARLYINCPR, levels = c("1", "2", "3", "4", "5", "6"), ordered = TRUE)

test <- polr(as.factor(YEARLYINCPR) ~ meanict_cat+ GENDER_Rn + meanEducation_cat, data = subChile, Hess=TRUE)
...
summary(std_dataC$meanict)
summary(std_dataC$YEARLYINCPR)
summary(Chile$YEARLYINCPR)
