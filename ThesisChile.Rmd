...
#Chile <- read.csv("/Users/mac/Desktop/wORKING dIRECTORY/prgecup1.csv")
...
std_dataC$meanict <- (std_dataC$G_Q05an + std_dataC$G_Q05cn + std_dataC$G_Q05dn + std_dataC$G_Q05en + std_dataC$G_Q05gn + std_dataC$G_Q06n + std_dataC$G_Q07n + std_dataC$G_Q08n)/8

# Creation  of a more general index of ICT with only 3  variables 

std_dataC$meanictBasic <- (std_dataC$G_Q04n + std_dataC$G_Q04_Tn + std_dataC$COMPUTEREXPERIENCE)/3

# Index of Education status

std_dataC$meanEducation <- (std_dataC$B_Q01an + std_dataC$B_Q01a_Tn + std_dataC$B_Q02an + std_dataC$B_Q01bn)/4

# Index of Work status

std_dataC$meanWorkS <- (std_dataC$C_Q01an + std_dataC$D_Q03n + std_dataC$D_Q14n + std_dataC$D_Q18a_T)/4
...
std_dataC$meanSoftS <- (std_dataC$F_Q01bn + std_dataC$F_Q02bn + std_dataC$F_Q02cn + std_dataC$F_Q02dn + std_dataC$F_Q02en + std_dataC$F_Q03bn + std_dataC$F_Q04an + std_dataC$F_Q05an + std_dataC$F_Q05bn)/9

# Index of Numeracy skills 

std_dataC$meanNumeracyS <- (std_dataC$G_Q03bn + std_dataC$G_Q03cn + std_dataC$G_Q03dn + std_dataC$G_Q03fn + std_dataC$G_Q03gn + std_dataC$G_Q03hn)/6

# Index of Literacy skills 

std_dataC$meanLiteracyS <- (std_dataC$G_Q01an + std_dataC$G_Q02an + std_dataC$G_Q02bn + std_dataC$G_Q02cn + std_dataC$G_Q02dn)/5
...
IncomeICTgender <- lm(YEARLYINCPR ~ meanict + GENDER_Rn + meanEducation + J_Q03an + J_Q03an +(meanict*GENDER_Rn),std_dataC)

IncomeICTgenderplus <- lm(YEARLYINCPR ~ meanict + GENDER_Rn + meanEducation +meanLiteracyS + meanSoftS +  meanNumeracyS+ J_Q03an  +J_Q06bn + J_Q07bn + (meanict*GENDER_Rn),std_dataC)

summary(IncomeICTgenderplus) 


IncomeICTgender <- lm(YEARLYINCPR ~ meanict + GENDER_Rn + meanEducation + J_Q03an + (meanict*GENDER_Rn),std_dataC)

summary(IncomeICTgender) 


IncomeICTgender2 <- lm(YEARLYINCPR ~ meanictBasic + GENDER_Rn + meanEducation +(meanictBasic*GENDER_Rn),std_dataC)

summary(IncomeICTgender2) 


IncomesoftICT <- lm(YEARLYINCPR ~  meanict + GENDER_Rn + meanSoftS + meanEducation + (meanict *meanSoftS),std_dataC)

summary(IncomesoftICT) 


IncomeNumeracy <- lm(YEARLYINCPR ~   meanict + GENDER_Rn + meanSoftS +  meanNumeracyS + meanEducation  + J_Q03an +J_Q06bn+C_Q01an+ J_Q07bn + (meanict *meanNumeracyS),std_dataC)
