...
Mexico <- read.csv("/Users/lu/Dropbox/Hertie/3/Thesis/Thesis-/Thesis.Rmd")
...
#C_Q01a
newMexico1$C_Q01an[newMexico1$C_Q01a == "D"] = NA
newMexico1$C_Q01an[newMexico1$C_Q01a == "1"] = 0
newMexico1$C_Q01an[newMexico1$C_Q01a == "2"] = 1
...
IncomeICTgender <- lm(YEARLYINCPR ~ meanict + GENDER_Rn + meanEducation + J_Q03an + J_Q03an +(meanict*GENDER_Rn),std_dataM)

IncomeICTgenderplus <- lm(YEARLYINCPR ~ meanict + GENDER_Rn + meanEducation +meanLiteracyS + meanSoftS +  meanNumeracyS+ J_Q03an  +J_Q06bn + J_Q07bn + (meanict*GENDER_Rn),std_dataM)

summary(IncomeICTgenderplus) 


IncomeICTgender <- lm(YEARLYINCPR ~ meanict + GENDER_Rn + meanEducation + J_Q03an + (meanict*GENDER_Rn),std_dataM)

summary(IncomeICTgender) 


IncomeICTgender2 <- lm(YEARLYINCPR ~ meanictBasic + GENDER_Rn + meanEducation +(meanictBasic*GENDER_Rn),std_dataM)

summary(IncomeICTgender2) 


IncomesoftICT <- lm(YEARLYINCPR ~  meanict + GENDER_Rn + meanSoftS + meanEducation + (meanict *meanSoftS),std_dataM)

summary(IncomesoftICT) 


IncomeNumeracy <- lm(YEARLYINCPR ~   meanict + GENDER_Rn + meanSoftS +  meanNumeracyS + meanEducation  + J_Q03an +J_Q06bn+C_Q01an+ J_Q07bn + (meanict *meanNumeracyS),std_dataM)

summary(IncomeNumeracy)
