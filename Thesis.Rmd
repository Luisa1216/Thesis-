...
newMexico1$B_Q02an[newMexico1$B_Q02a == "1"] = 1
newMexico1$B_Q02an[newMexico1$B_Q02a== "2"] = 2
...
newMexico1$F_Q07bn[newMexico1$F_Q07b == "1"] = 1
newMexico1$F_Q07bn[newMexico1$F_Q07b == "2"] = 2
...
newMexico1$G_Q04n[newMexico1$G_Q04 == "1"] = 1
newMexico1$G_Q04n[newMexico1$G_Q04 == "2"] = 2
...
newMexico1$G_Q07n[newMexico1$G_Q07 == "1"] =1
newMexico1$G_Q07n[newMexico1$G_Q07 == "2"] =2
...
newMexico1$G_Q08n[newMexico1$G_Q08 == "1"] =1
newMexico1$G_Q08n[newMexico1$G_Q08 == "2"] =2
...
newMexico1$H_Q04an[newMexico1$H_Q04a == "1"] =1
newMexico1$H_Q04an[newMexico1$H_Q04a == "2"] =2

#H_Q04b

newMexico1$H_Q04bn[newMexico1$H_Q04b == "V"] =NA
newMexico1$H_Q04bn[newMexico1$H_Q04b == "N"] =NA
newMexico1$H_Q04bn[newMexico1$H_Q04b == "1"] =1
newMexico1$H_Q04bn[newMexico1$H_Q04b == "2"] =2
...
newMexico1$J_Q03an[newMexico1$J_Q03a == "1"] = 1
newMexico1$J_Q03an[newMexico1$J_Q03a == "2"] = 2
...
ICTwork1reg <- lm(YEARLYINCPR ~ AGE_R + GENDER_R + G_Q05an + G_Q05cn + G_Q05dn + G_Q05en + G_Q05gn + G_Q05hn + G_Q06n + G_Q07n + G_Q08n, newMexico1ICTwork1)

ICTreg1 <- lm(YEARLYINCPR ~ AGE_R + GENDER_R + G_Q05an + G_Q05cn + G_Q05dn + G_Q05en + G_Q05gn + G_Q05hn + G_Q06n + G_Q07n + G_Q08n + H_Q05an + H_Q05cn + H_Q05dn + H_Q05en + H_Q05fn + H_Q05gn + H_Q05hn, newMexico1ICTwork1)
