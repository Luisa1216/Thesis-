...
newEcuador1 <- drop_na(newEcuador, YEARLYINCPR)
...
newEcuador1 %>% count(B_Q02c) #x - 3224 V ESTA 1
newEcuador1 %>% count(B_Q10c) #x- 3176 V ESTA 2
newEcuador1 %>% count(B_Q01b) # 2134 v ESTA 3

# Work status 
newEcuador1 %>% count(C_Q01a)
newEcuador1 %>% count(C_Q01c) # 3459 v ESTA 4
newEcuador1 %>% count(C_Q02a) # 3459 v ESTA 5 
newEcuador1 %>% count(D_Q03) # D 42 - r21 
newEcuador1 %>% count(D_Q14) #
newEcuador1 %>% count(D_Q16a) # V 1008
newEcuador1 %>% count(D_Q18a_T) # 13 NA 


# ICT skills in Job
newEcuador1 %>% count(G_Q04) # experience with computer in job yes no 
newEcuador1%>% count(G_Q04_T) #** 4 N
newEcuador1 %>% count(COMPUTEREXPERIENCE) #******
newEcuador1 %>% count(G_Q05a) # 2377 v ESTA 6 
newEcuador1 %>% count(G_Q05c) # 2377 v ESTA 7 
newEcuador1 %>% count(G_Q05d) # 2377 ESTA 8 
newEcuador1 %>% count(G_Q05e) # 2377 ESTA 9 
newEcuador1 %>% count(G_Q05g) # 2377 ESTA 10 
newEcuador1 %>% count(G_Q05h) # 2377 ESTA 11 
newEcuador1 %>% count(G_Q06) # 2377 ESTA 12 
newEcuador1 %>% count(G_Q07) # 2377 ESTA 13 
newEcuador1 %>% count(G_Q08) # 2377 ESTA 15 

#ICT skills in daily life
newEcuador1 %>% count(H_Q04a) # 1074 V experience with compiuter every life
newEcuador1 %>% count(H_Q04b) # 1198 
newEcuador1 %>% count(H_Q05a) # 2205 ESTA 16 
newEcuador1 %>% count(H_Q05c) # 2205 ESTA 17 
newEcuador1 %>% count(H_Q05d) # 2205 ESTA 18 
newEcuador1 %>% count(H_Q05e) # 2205 ESTA 19 
newEcuador1 %>% count(H_Q05f) # 2205 ESTA 20 
newEcuador1 %>% count(H_Q05g) # 2205 ESTA 21 
newEcuador1 %>% count(H_Q05h) # 2205 ESTA 22 

# Children and parents level of education
newEcuador1 %>% count(J_Q03a)
newEcuador1 %>% count(J_Q03b) #943
newEcuador1 %>% count(J_Q06b) 

# Soft skills 
newEcuador1 %>% count(F_Q01b) #748
newEcuador1 %>% count(F_Q02b) 
newEcuador1 %>% count(F_Q02c)
newEcuador1 %>% count(F_Q02d)
newEcuador1 %>% count(F_Q02e)
newEcuador1 %>% count(F_Q03b)
newEcuador1 %>% count(F_Q04a)
newEcuador1 %>% count(F_Q04b)
newEcuador1 %>% count(F_Q05a)
newEcuador1 %>% count(F_Q05b)

# Literacy work 
newEcuador1 %>% count(G_Q01a)
newEcuador1 %>% count(G_Q02a)
newEcuador1 %>% count(G_Q02b)
newEcuador1 %>% count(G_Q02c)
newEcuador1 %>% count(G_Q02d)
...
## Income variables
Ecuador %>% count(YEARLYINCPR) #2847
Ecuador  %>% count(EARNMTH) #2847
Ecuador  %>% count(EARNMTHPPP) #3t68
Ecuador  %>% count(EARNHR)#3758
Ecuador  %>% count(EARNHRBONUS) # 97 ESPACIOS VACIOS 
Ecuador  %>% count(ICTWORK)
Ecuador  %>% count(EARNHRBONUSPPP) # 97 vacios usd 
Ecuador  %>% count(EARNFLAG) 
```
