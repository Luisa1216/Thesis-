...
#Ecuador <- read.csv("/Users/mac/Desktop/wORKING dIRECTORY/prgecup1.csv")
...
newEcuador2 <- drop_na(newEcuador, YEARLYINCPR)
...
std_data = as.data.frame(apply(newEcuador1[87:166],2,standardize))

#std_data1 = as.data.frame(apply(subEcuador,2,standardize))

subEcuador$meanict <- (std_data$G_Q05an + std_data$G_Q05cn + std_data$G_Q05dn + std_data$G_Q05en + std_data$G_Q05gn + std_data$G_Q06n + std_data$G_Q07n + std_data$G_Q08n)/8
