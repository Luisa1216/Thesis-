...
--> For ICT skills in work they have 3129 Vs  and 2 Ns out of 4825 observations. 
--> For ICT skills in daily life 2465 Vs and 3 Ns out of 4825 observations. 
...
newPeru1 %>% count(G_Q05a) # 3129  + N 2
newPeru1 %>% count(G_Q05c) # 3129  + N 2
newPeru1 %>% count(G_Q05d) # 3129  + N 2
newPeru1 %>% count(G_Q05e) # 3129  + N 2
newPeru1 %>% count(G_Q05g) # 3129  + N 2
newPeru1 %>% count(G_Q05h) # 3129  + N 2 
newPeru1 %>% count(G_Q06) # 3129  + N 2
newPeru1 %>% count(G_Q07) # 3129  + N 2
newPeru1 %>% count(G_Q08) # 3129  + N 2
